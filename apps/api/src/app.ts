...
export function createApp(deps: AppDeps): Express {
  ...
  // Permissive CORS in dev. In prod, restrict via WEB_ORIGIN env.
  ...
  if (deps.mainnetRpcUpstream) {
    app.use("/rpc", rpcRouter({ upstreamUrl: deps.mainnetRpcUpstream }));
  }
